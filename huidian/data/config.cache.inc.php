...
$cfg_multi_site = 'N';
$cfg_dede_log = 'N';
$cfg_powerby = 'Copyright &copy; 2016-2020 HDEA.慧点家居 版权所有';
$cfg_arcsptitle = 'N';
$cfg_arcautosp = 'N';
...
$cfg_rewrite = 'N';
$cfg_delete = 'Y';
$cfg_keywords = '武隆县慧点家居,家居网,家居，武隆县';
$cfg_description = '    慧点家居的产品遍布全国，拥有数百家专卖店，以"让您的家与众不同"为宗旨，用专业的服务向人们传递一种经历了时光深淀后享受人生的智慧态度；品位一份优雅的感受、一种平凡的家居生活，从设计、配置、配饰，到售后服务，慧点家居全心全意为懂得生活品味的您们提供便捷优质的服务。
    主要经营上海慧点家居旗下品牌：HDEA慧点、YES-NO，里外Lv软床系列，另有配套的窗帘、茶几、电视柜、时尚多功能少发床等。';
$cfg_beian = '渝ICP备17001575号';
$cfg_need_typeid2 = 'Y';
$cfg_cache_type = 'id';
$cfg_max_face = 50;
$cfg_typedir_df = 'Y';
...
$cfg_tongji = '<script type="text/javascript">var cnzz_protocol = (("https:" == document.location.protocol) ? " https://" : " http://");document.write(unescape("%3Cspan id=cnzz_stat_icon_1261211397%3E%3C/span%3E%3Cscript src=" + cnzz_protocol + "s95.cnzz.com/z_stat.php%3Fid%3D1261211397%26show%3Dpic type=text/javascript%3E%3C/script%3E"));</script>';
$cfg_qq = '490771378';
$cfg_kefutel = '023-77821313';
?>